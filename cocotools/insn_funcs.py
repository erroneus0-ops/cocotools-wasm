...
def insn_parse_logicmem(as_, cl, operand):
    cl.len = 3; return operand   # stub

def insn_resolve_logicmem(as_, cl, force): pass
def insn_emit_logicmem(as_, cl): pass
...
def insn_parse_tfm(as_, cl, operand):      cl.len = 3; return operand
def insn_resolve_tfm(as_, cl, force):      pass
def insn_emit_tfm(as_, cl):               pass
def insn_parse_tfmrtor(as_, cl, operand):  cl.len = 3; return operand
def insn_resolve_tfmrtor(as_, cl, force):  pass
def insn_emit_tfmrtor(as_, cl):           pass
...
def insn_parse_bitbit(as_, cl, operand):  cl.len = 4; return operand
def insn_resolve_bitbit(as_, cl, force):  pass
def insn_emit_bitbit(as_, cl):            pass
